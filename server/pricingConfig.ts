...
const DEFAULT_ROWS: PricingEntry[] = [
  ...
  { key: ACTION_KEYS.business_plan, category: "action", name: "商业计划书", credits: 5000, priceCents: null, monthlyCredits: null, durationDays: null, permanent: false },
  { key: ACTION_KEYS.equity_structure, category: "action", name: "股权架构", credits: 6000, priceCents: null, monthlyCredits: null, durationDays: null, permanent: false },
  ...
  { key: "subscription.professional", category: "subscription", name: "专业版", credits: null, priceCents: 29900, monthlyCredits: 6000, durationDays: 30, permanent: false },
  { key: "subscription.enterprise", category: "subscription", name: "旗舰版", credits: null, priceCents: 69900, monthlyCredits: 15000, durationDays: 30, permanent: false },
