    ...
    <div className="min-h-screen bg-[var(--zs-bg)] text-[var(--zs-ink)]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[var(--zs-primary)]">泽思 AI 隐私政策</h1>
          <p className="text-[var(--zs-sub)] mt-2">版本日期：2026 年 01 月 12 日</p>
        </div>

        <div className="prose max-w-none space-y-6 text-[var(--zs-ink)]">
          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">引言</h2>
          ...
          <div className="bg-[var(--zs-primary-soft)] border border-[rgba(201,162,75,.45)] rounded-lg p-4 my-6">
            <p className="font-semibold text-[var(--zs-primary)] mb-2">本政策将帮助您了解以下内容：</p>
          ...
          <p>本隐私政策与您所使用的 泽思 AI 产品和/或服务以及该服务所包括的各种业务功能息息相关，并应与我们的 <Link href="/terms" className="font-medium text-[var(--zs-primary)] underline decoration-[var(--zs-gold)] underline-offset-4">用户协议</Link> 一并阅读，希望您在访问前仔细阅读并确认您已经充分理解本隐私政策所写明的内容，并让您可以按照本隐私政策的指引做出您认为适当的选择。</p>

          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">一、我们如何收集和使用您的个人信息</h2>
          
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">定义</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">个人敏感信息</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">您须授权我们收集和使用您个人信息的情形</h3>
          ...
          <div className="overflow-x-auto my-6">
            <table className="w-full border-collapse border border-[var(--zs-line)]">
              <thead>
                <tr className="bg-[var(--zs-primary-soft)]">
                  <th className="border border-[var(--zs-line)] px-4 py-2 text-left">产品</th>
                  <th className="border border-[var(--zs-line)] px-4 py-2 text-left">个人信息类型</th>
                  <th className="border border-[var(--zs-line)] px-4 py-2 text-left">用途</th>
                  <th className="border border-[var(--zs-line)] px-4 py-2 text-left">地址</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-[var(--zs-line)] px-4 py-2">泽思 AI</td>
                  <td className="border border-[var(--zs-line)] px-4 py-2">手机号、电子邮箱</td>
                  <td className="border border-[var(--zs-line)] px-4 py-2">注册、登录、接收服务通知</td>
                  <td className="border border-[var(--zs-line)] px-4 py-2">https://zesiai.com/</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">在您使用服务过程中我们会收集以下的信息</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">无需征得您授权同意的情形</h3>
          ...
          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">二、我们如何使用 Cookies</h2>
          ...
          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">三、我们如何共享、转让、公开披露您的个人信息</h2>
          
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">共享</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">转让</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">公开披露</h3>
          ...
          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">四、我们如何保护和保存您的个人信息</h2>
          
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">安全防护措施</h3>
          <p>我们会努力采用符合业界标准的安全防护措施，包括建立合理的制度规范、安全技术、定期进行安全漏洞扫描来防止您的个人信息遭到未经授权的访问、使用、修改，避免数据的损坏或丢失。</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">加密技术</h3>
          <p>我们的网络服务采取了传输层安全协议等加密技术，通过 https 等方式提供浏览服务，确保用户数据在传输过程中的安全。</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">数据保留</h3>
          <p>我们只会在达成本隐私政策所述目的所需的期限内保留您的个人信息，保存期限届满后如您未另行授权或您的订单已无相关争议及纠纷，我们将删除您的个人信息或将其进行匿名化处理。</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">访问控制</h3>
          <p>我们仅允许有必要知晓这些信息的我们及我们关联方的员工访问个人信息，并为此设置了严格的访问权限控制和监控机制。</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">安全事件响应</h3>
          <p>在不幸发生个人信息安全事件后，我们将按照法律法规的要求，及时向您告知：安全事件的基本情况和可能的影响、我们已采取或将要采取的处置措施、您可自主防范和降低风险的建议、对您的补救措施等。</p>

          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">五、您如何管理您的个人信息</h2>
          <p>我们非常重视您对个人信息的关注，并尽全力保护您对于您个人信息访问、更正、删除以及撤回同意的权利，以使您拥有充分的能力保障您的隐私和安全。您的权利包括：</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">1. 访问和更正您的个人信息</h3>
          <p>除法律法规规定的例外情形外，您有权请求访问您的个人信息。当您发现我们处理的关于您的信息有错误时，您有权更正不准确或不完整的信息。您可以通过我们的邮箱与我们取得联系。</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">2. 删除您的个人信息</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">3. 注销</h3>
          <p>您可以向我们的邮箱发送账号注销申请。您注销账户后，我们将停止为您提供产品和/或服务，您无法再通过原账号进行登录或进行任何操作。请您注意，账号注销后则无法恢复，请您谨慎使用注销功能。</p>

          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">六、未成年人的个人信息保护</h2>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">父母同意</h3>
          <p>对于经父母或法定监护人同意而收集未成年人个人信息的情况，我们只会在受到法律允许、父母或监护人明确同意或者保护未成年人所必要的情况下使用、共享、转让或披露此信息。</p>

          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">账号冻结</h3>
          <p>如我们发现未成年人并未实际取得父母或法定监护人同意的情况下注册使用了我们的产品和/或服务，我们会暂时冻结该账号，届时将不能使用我们的产品和/或服务，同时我们会尝试与监护人取得联系，并设法尽快删除未成年人的个人信息。</p>

          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">七、本政策如何更新</h2>
          ...
          <h3 className="text-lg font-semibold text-[var(--zs-primary)] mt-6 mb-3">重大变更</h3>
          ...
          <h2 className="text-xl font-bold text-[var(--zs-primary)] mt-8 mb-4">八、如何联系我们</h2>
