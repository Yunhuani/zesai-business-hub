/**
 * Direct PPT Engine Test - Tests core modules without HTTP/auth
 * Uses tsx to run TypeScript directly
 */
import { execSync } from 'child_process';

// We need to use tsx to run TS files directly
// Let's create a TS test file and run it with tsx
import fs from 'fs';
...
fs.writeFileSync('/home/ubuntu/zesai-business-hub/test-ppt-direct.ts', testScript);
console.log('Test script written. Run with: npx tsx test-ppt-direct.ts');
