...
VALUES
	...
	('action.business_plan', 'action', '商业计划书', 5000, NULL, NULL, NULL, 0),
	('action.equity_structure', 'action', '股权架构', 6000, NULL, NULL, NULL, 0),
	...
	('subscription.professional', 'subscription', '专业版', NULL, 29900, 6000, 30, 0),
	('subscription.enterprise', 'subscription', '旗舰版', NULL, 69900, 15000, 30, 0),
